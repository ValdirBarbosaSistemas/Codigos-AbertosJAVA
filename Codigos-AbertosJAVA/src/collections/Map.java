...
public class Map {
	public static void main(String[] args) {
		...
		//A declaracao de MAP se faz desse modo (Ex. Codigo do usuário e o nome do usuário)
		
		/*No map não temos o método add (adicionar), ou seja, para adicionar o elemento no map
		 * teríamos que utilizar o PUT e os elementos declarados
		 */
		usuarios.put(1, "Roberto"); //Adicionando elementos
		
		/*A diferença entre o PUT e o ADD é que no PUT voce adiciona na primeira vez
		 * e quando for na SEGUNDA VEZ ele SUBSTITUI O VALOR
		 */
		...
		//Neste caso ele só irá mostrar o tamanho 1 do elemento, pois como ele substituiu acontece isso
