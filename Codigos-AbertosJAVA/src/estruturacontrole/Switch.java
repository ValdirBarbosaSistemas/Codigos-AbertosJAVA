...
public class Switch {
	...
	}	/* Neste caso o Switch é tipo uma outra 'Alternativa' do IF-ELSE e também lembrando que
		* o switch está SEM O BREAK, ou seja, ele vai aparecer na tela TODAS as impressões do texto */
}
