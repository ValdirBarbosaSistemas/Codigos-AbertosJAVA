...
public class TesteConexao {
	public static void main(String[] args) throws SQLException {
		...
		/*
		 * jdbc = em que local vou estar acessando o banco de dados? mysql = Nome do
		 * drive que vai acessar localhost = nome do servidor
		 */
		 ...
		 * poderíamos lançar a mesma para 'outra' pessoal poder tratar
		 */
